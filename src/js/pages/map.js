...
const _0 = {
    ...
    result : {
        show : function () { _0.el(`section.list .result`).setAttribute(`data-folded`, `false`); },
        hide : function () { _0.el(`section.list .result`).setAttribute(`data-folded`, `true`); },
    },
    detail : {
        show : function () { _0.el(`section.detail`).setAttribute(`data-show`, `true`); },
        hide : function () { _0.el(`section.detail`).setAttribute(`data-show`, `false`); },
    },
    filter : {
        reset : function () {
